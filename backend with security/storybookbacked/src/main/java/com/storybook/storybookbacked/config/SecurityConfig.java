package com.storybook.storybookbacked.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                    ...
                    .requestMatchers("/api/books/**").authenticated()  // Allow authenticated users only
                    .requestMatchers("/api/web/**").permitAll()  // Allow all users for the web endpoints
